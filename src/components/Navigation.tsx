      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <span className="text-2xl font-bold text-primary tracking-wider group-hover:text-primary/80 transition-colors">
              KHOROUSH
            </span>
          </Link>
            ...
            <div className="flex flex-col space-y-4">
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-base font-medium transition-colors px-4 py-2 rounded ${
                    isActive(link.path)
